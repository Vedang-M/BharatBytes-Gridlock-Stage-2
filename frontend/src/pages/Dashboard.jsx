...
export default function Dashboard() {
  ...
  return (
    <div className="page-container">
      ...
      {/* ── Page Header with Morning Brief button ── */}
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 0 32px rgba(37,99,235,0.55)'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
          onMouseLeave={e => { e.currentTarget.style.boxShadow = '0 0 24px rgba(37,99,235,0.35)'; e.currentTarget.style.transform = 'translateY(0)'; }}
        >
      ...
      {/* ── Morning Brief Modal ── */}
      {showBrief && <MorningBrief onClose={() => setShowBrief(false)} />}
